...
public class ChatRoute extends RouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    from("websocket://0.0.0.0:9090/chat").routeId("ChatRoute").log(LoggingLevel.INFO, ">> Message received : ${body}")
        .to("websocket://0.0.0.0:9090/chat?sendToAll=true&staticResources=classpath:webapp");
  }
}
